defmodule Explorer.Repo.Shinerium.Migrations.CreateBlobsTables do
  use Ecto.Migration

  def change do
    create table(:shinerium_blobs_transactions, primary_key: false) do
    ...
    create table(:shinerium_blobs, primary_key: false) do
